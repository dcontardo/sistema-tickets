...
const Tickets = () => {
  ...
  const fetchTickets = async () => {
    ...
    if (usuario?.tipo === "estudiante") {
      visibles = data.filter((ticket) => ticket.usuario === usuario.id);
    } else if (usuario?.tipo === "funcionario") {
      visibles = data.filter((ticket) => ticket.area === usuario.area);
    }
  ...
  ].filter(Boolean); // Limpia las columnas falsas si el usuario es estudiante
